...
class Book {
  constructor({
    ...
    onCurrentPageChange,
    onPageTurningStatusChange,
  }) {
    this._onPageVisibilityChange = onPageVisibilityChange || function() {};
    this._onCurrentPageChange = onCurrentPageChange || function() {};
    this._onPageTurningStatusChange = onPageTurningStatusChange || function() {};
  ...
  _dragStart(e) {
    ...
    this._onPageTurningStatusChange(true);
  }
  ...
  _setCurrentPage(newCurrentPage) {
    ...
    this._onCurrentPageChange({ currentPage: this._currentPage, previousPage });
  }
  ...
  _stopFinishing() {
    this._finishingDirection = 0;
    this._onPageTurningStatusChange(false);
